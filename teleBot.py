...
bot = telebot.TeleBot("5854704525:AAEOF22PPomZ6eggfdY2ee9YePhUTptVfNo")

def OpenListW():
    check_file = os.path.isfile('calculator_history.txt')
    if check_file == False:
        file = open('calculator_history.txt', 'w')
        file.close()
...
def number1(message):
    ...
    file = open('calculator_history.txt', 'a')
